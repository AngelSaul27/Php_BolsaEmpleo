...
class Listado_Solicitudes extends TCPDF
{
    ...
    function loadData()
    {
        ...
        $Contenido = $funcion->stringBody($Contenido, null); //PROCESS DATA TABLE
        ...
        $FILE_SAVE = constant('PDF_FILE') . 'empleador/' . $FILE_NAME;

        //GUARDAMOS EL PDF
        $pdf->Output($FILE_SAVE, 'F');

        echo constant('URL') . 'public/docs/empleador/' . $FILE_NAME; //DEVOLVEMOS EL PDF
    }
}
