        ...
        <?php if (isset($this->estadisticas) or !empty($this->estadisticas)) : ?>
            <div class="flex gap-10 align-center" style="justify-content: right">
                <select name="" id="changue_filter" style="width: max-content">
                    ...
                    <option data-referencia="categoria" value="<?php echo constant('URL') . 'empleador/mis_contrataciones/categoria/?ref=categoria' ?>">Categoria</option>
                    <option data-referencia="mes" value="<?php echo constant('URL') . 'empleador/mis_contrataciones/mes/?ref=mes' ?>">Meses</option>
                    <option data-referencia="Contrataciones" value="<?php echo constant('URL') . 'empleador/mis_contrataciones/Oferta_id/?ref=Contrataciones' ?>">Contrataciones</option>
                </select>
    ...
    <script>
        ...
        switch (param) {
            ...
            case 'consulta':
                ...
                break;
            case 'Contrataciones':
                $('#changue_filter_placeholder').text('Contrataciones');
                $('option[data-referencia=Contrataciones]').css('display', 'none');
                break;
            default:
                $('option[data-referencia=Contrataciones]').css('display', 'none');
                break;
